...
// branches — as a pickerScreen: enter installs the chosen item. It's a thin wrapper
// that wires items + behavior into the reusable picker, reached from the addon
// submenu's Install command.
